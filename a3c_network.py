...
class Worker:
    # Creating a worker/agent for the network
    ...
    def _create_network(self):
        # 3 Convolutional Neural Network Layers
        ...
        # Recurrent information network for temporal dependencies
    ...
    def _create_loss(self):
        ...
        # In order to explore more, we want the entropy to be bigger, then the loss is smaller
    ...
    def train(self, env, checkpoint_interval, saver, t_writer, gamma=0.99):
        ...
        while T < self.TMAX:
            ...
            while not (terminal or (t == self.tmax)):
                ...
                # Receiving a new Reward Rt and new_state St+1
            ...
            # If state at t is terminal, set Reward at t to 0
                    # Else set Reward at t to state value function parameterized by w' 
                    # that measures the expected returns state of s
            if terminal:
                R_t = 0
            else:
            ...
            # For i = t - 1, ..., tstart
            # R is a measure of the discounted future reward
            ...
            # Adding current step's cost to total cost
            total_cost += cost
