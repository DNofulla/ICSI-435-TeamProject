...
def main(args):
    ...
    global_network = Worker(-1, num_actions, 1e-4, sess,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--loadpath', type=str,
                        default='/path/to/model/', help="Path to load model.")
    parser.add_argument('--player', type=str, default='Bandit',
                        help="Player that you want to play.")
